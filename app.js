...
const QUESTIONS = [
  ...
  ['一件事变复杂了，你通常赢在：', ['我比别人更早看出后面会怎么炸', '我不容易乱，能把它慢慢理顺', '只要我进去，这事就会开始变得可控']],
  ['如果团队里有人最容易被抓来救火，大概率是因为：', ['他能把事情稳住', '他能把快死的局救回来', '他比较全，哪里缺都能补一手']],
  ['你这种人的强，更像哪一种：', ['平时不一定最吵，关键时候特别顶', '一开始不一定显眼，但越往后越离不开', '没有哪一项特别夸张，但整体就是很难替代']],
  ...
  ['别人最容易误会你的地方是：', ['觉得你想太多', '觉得你有点冷', '觉得你平时没怎么出力']],
  ['如果有人背后说你“有点难搞”，大概率是因为：', ['你边界确实硬', '你太清醒，不容易被带跑', '你总能一眼看穿别人的小九九']],
  ['如果只能让别人记住你一种感觉，你更想要的是：', ['关键时候这人是真的顶', '一开始不一定觉得，但越合作越觉得这人值', '这人不一定最吵，但真挺难替代']],
  ['在一段关系或者一次合作里，你最常做的事是：', ['接住快掉地上的场面', '稳住节奏，别让它乱下去', '让事情继续往前走，不停在那耗着']],
  ['如果非要给自己贴个标签，你更像：', ['我不怎么轻易出手，但一出手一般都挺重', '我不一定第一眼讨喜，但时间会替我说话', '我不一定抢风头，但局面经常会慢慢往我这边靠']]
].map((item, index) => ({
  id: index + 1,
  text: item[0],
