...
const QUESTIONS = [
  ['群里已经冷了十分钟，消息停在一个尴尬的表情包上，你一般会：', ['继续潜水，当没看见', '找个不尴尬的角度把话接起来', '直接扔个东西把场子炸热']],
  ['明明这事你最懂，结果有人已经开始一本正经乱讲了，你会：', ['懒得争，先记住这个人', '找个机会把重点接回来，让大家听懂真的在说啥', '直接让他知道，懂和装懂不是一回事']],
  ['一个你等了挺久的机会终于轮到你了，你第一反应更像：', ['先别激动，先看看值不值得我真上', '先坐稳了再说，别刚上桌就飘', '终于轮到我了，那这把我得狠狠干']],
  ['朋友临时放你鸽子，还轻飘飘来一句“下次补”，你心里第一句更像：', ['算了，也不是第一次了', '行，我记住了，但我先不说', '不行，这种事我得让他知道不太对']],
  ['一个项目已经乱得像临时拼起来的菜市场，你更可能：', ['先把最乱那块按住', '想办法把快散掉的局重新接起来', '这种时候别磨叽了，我来接管']],
  ['大家第一次见你，最容易先给你贴上的标签是：', ['这人感觉不太简单', '这人应该挺会来事', '这人话不一定多，但感觉留了后手']],
  ['那种又长又烦、还得磨很久的事，你更像：', ['一旦决定做，我就会一直往前推', '刚开始一般，越到后面越来劲', '先别急，我先想想有没有更聪明的做法']],
  ['一桌人越聊越散，已经开始各说各的了，你会：', ['再看看，没必要我先动', '找个点把大家重新拢回来', '直接换个话题，把节奏拿过来']],
  ['你忙了半天，结果有人顺手把功劳往自己身上揽，你会：', ['先不说，后面我会把这账翻回来', '当场把自己的位置拿回来', '不吵，但我会让他知道这事不能这么干']],
  ['一件事越做越复杂，大家开始有点慌的时候，你通常赢在：', ['我比别人更早看出后面会怎么炸', '我不容易乱，能把它慢慢理顺', '只要我进去，这事就会开始变得可控']],
  ['如果团队里总有人一到出事就被默认艾特出来，大概率是因为：', ['他能把事情稳住', '他能把快死的局救回来', '他比较全，哪里缺都能补一手']],
  ['合作一阵子后，别人最容易后知后觉发现你真正值钱的是：', ['平时不一定最吵，关键时候是真的顶', '一开始不一定显眼，但越往后越离不开', '没有哪一项最夸张，但整体就是很难替代']],
  ['大家都开始上头、语速变快、眼看要吵歪的时候，你通常会：', ['先在心里把这局看明白', '先想后面会不会翻车', '先把最容易炸的地方按住']],
  ['别人夸你厉害，嘴上没说全的话大概是：', ['你这人就是有种不太好替代的感觉', '你能把事做了，但人还挺鲜活', '你一认真起来，别人看着都累']],
  ['你去一个陌生局，通常更像哪种开场：', ['还没怎么说话，存在感先到了', '很快就能把气氛接住', '先安静一下，把人和局都扫一遍']],
  ['一件事眼看要输了，你第一反应更像：', ['我还能给它翻回来', '我先把最差的结果兜住', '我先让这个局别彻底死掉']],
  ['别人说你“有点贵”，翻译成人话更像是在说：', ['你身上有种不太像普通人的稀缺感', '你一站那儿就不太像好惹的', '你这人感觉迟早会坐到更前面去']],
  ['真到该拍板的那几分钟，你更像：', ['前面不一定说很多，开口的时候基本就定了', '我其实前面一直在慢慢控节奏', '你以为我没动作，其实我后手都想好了']],
  ['别人夸你，最容易反复提到的点更像：', ['你这人分寸拿得挺准', '你站那儿就有点压场', '你越往后越显得有东西']],
  ['你今天状态很烂，但还得出去见人、回消息、把流程走完，你更可能：', ['就这样吧，谁爱看不看', '先想办法把自己哄好，再决定见不见人', '嗯嗯好的哈哈，把流程走完就撤']],
  ['如果有人背后说你“有点难搞”，大概率是因为：', ['你边界确实硬', '你太清醒，不容易被带跑', '你总能一眼看穿别人的小九九']],
  ['如果只能让合作过的人记住你一种感觉，你更想是：', ['关键时候这人是真的顶', '一开始不一定炸，但越合作越觉得这人值', '这人不一定最吵，但真挺难替代']],
  ['在一段关系或者一次合作里，你最常自动接过去的活是：', ['接住快掉地上的场面', '稳住节奏，别让它乱下去', '让事情继续往前走，不停在那耗着']],
  ['周末终于没人找你了，手机也安静了，你最想：', ['随便活一下，主打一个活人味儿', '给自己安排点吃的喝的，把自己照顾舒服', '直接切省电模式，谁也别来打扰']]
].map((item, index) => ({
  id: index + 1,
  text: item[0],
...
const WEIGHTS = {
  ...
  10: { A: { READ: 2, WAKE: 1 }, B: { ANCH: 2, FULL: 1 }, C: { ULTI: 2, CTRL: 1 } },
  11: { A: { ANCH: 2, ULTI: 1 }, B: { SAVE: 2, LIVE: 1 }, C: { FULL: 2, LIVE: 1 } },
  12: { A: { ULTI: 2, ANCH: 1 }, B: { LAST: 2, ANCH: 1 }, C: { FULL: 2, LIVE: 1 } },
  ...
  20: { A: { LIVE: 2, HARD: 1 }, B: { LIVE: 2, HOLD: 1 }, C: { WAKE: 2, LAST: 1 } },
  21: { A: { HARD: 2, AURA: 1 }, B: { WAKE: 2, READ: 1 }, C: { READ: 2, HOLD: 1 } },
  22: { A: { ULTI: 2, ANCH: 1 }, B: { LAST: 2, RICH: 1 }, C: { FULL: 2, RICH: 1 } },
  23: { A: { SAVE: 2, CTRL: 1 }, B: { ANCH: 2, HOLD: 1 }, C: { BURN: 2, CTRL: 1 } },
  24: { A: { LIVE: 2, FULL: 1 }, B: { HOLD: 2, LIVE: 1 }, C: { WAKE: 2, LAST: 1 } },
};
